...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hu.daniinc.reservation.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hu.daniinc.reservation.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, hu.daniinc.reservation.domain.User.class.getName());
            createCache(cm, hu.daniinc.reservation.domain.Authority.class.getName());
